...
import { BookOpen, Folder, Menu, Package, Search } from 'lucide-vue-next';
...
const authUserFullName = computed(() => (auth.value.user ? `${auth.value.user.first_name} ${auth.value.user.last_name}` : ''));
                        ...
                        <DropdownMenuTrigger :as-child="true">
                            ...
                            >
                                <Avatar class="size-8 overflow-hidden rounded-full">
                                    <AvatarImage :src="auth.user.avatar" :alt="authUserFullName" />
                                    <AvatarFallback class="rounded-lg bg-neutral-200 font-semibold text-black dark:bg-neutral-700 dark:text-white">
                                        {{ getInitials(authUserFullName) }}
                                    </AvatarFallback>
                                </Avatar>
                            </Button>
                        </DropdownMenuTrigger>
